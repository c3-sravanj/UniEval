...
class SumEvaluator:
    def __init__(self, max_length=1024, device="cpu", cache_dir=None):
        ...
        self.scorer = UniEvaluator(
            model_name_or_path="MingZhong/unieval-sum", max_length=max_length, device=device, cache_dir=cache_dir
        )
...
class DialogEvaluator:
    def __init__(self, max_length=1024, device="cpu", cache_dir=None):
        ...
        self.scorer = UniEvaluator(
            model_name_or_path="MingZhong/unieval-dialog", max_length=max_length, device=device, cache_dir=cache_dir
        )
        self.task = "dialogue"
...
class FactEvaluator:
    def __init__(self, max_length=1024, device="cpu", cache_dir=None):
        ...
        self.scorer = UniEvaluator(
            model_name_or_path="MingZhong/unieval-fact", max_length=max_length, device=device, cache_dir=cache_dir
        )
        self.task = "fact"
...
def get_evaluator(task, max_length=1024, device="", cache_dir=None):
    if not device:
    ...
    if task == "summarization":
        ...
        return DialogEvaluator(max_length=max_length, device=device, cache_dir=cache_dir)
    elif task == "data2text":
